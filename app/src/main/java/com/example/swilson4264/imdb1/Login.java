    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signInBtn.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View view){
                ...
                if (sEmail.equals(user.getEmail() ) && sPassword.equals(user.getPassword())) {

                    Intent intent = new Intent(Login.this, HomeScrean.class);
                    startActivity(intent);

                }
               else if(!sEmail.equals(user.getEmail())){
                ...
                else if(!sPassword.equals(user.getEmail())){
